...
class IWantToGoPage extends StatefulWidget {
  const IWantToGoPage({super.key});

  @override
  State<IWantToGoPage> createState() => _IWantToGoPage();
}

class _IWantToGoPage extends State<IWantToGoPage> {
